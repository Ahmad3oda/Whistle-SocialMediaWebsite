...
public class FriendController {
    ...
    public List<FriendRequestDetails> getRequestList(@PathVariable Integer userId) {
        return friendService.getRequests(userId);
    }

    // get the suggestions list by id.
    @GetMapping("/suggestions/{userId}")
    public List<FriendRequestDetails> getSuggestionList(@PathVariable Integer userId) {
        return friendService.getSuggestions(friendService.getFriends(userId), userId);
    }

    private class IsFriendClass{
    ...
    public IsFriendClass isFriend(@PathVariable Integer senderId, @PathVariable Integer receiverId) {
        IsFriendClass isFriendClass = new IsFriendClass();
        isFriendClass.setIsFriend (friendService.areFriends(senderId, receiverId));
